<?php
$title = "Cadastro Educação - Exclusão de Aluno";
...
$link_deleteAluno = '../../Controller/deleteAluno.php';
...
<div class="container-fluid" style="width:100%; justify-content: center; text-align: center; ">
    ...
    <div>
        ...
        <hr />
        <form method="GET" action="<?php echo $link_deleteAluno ?>">
            ...
            <br />
            <div>
                <h3>Excluir este Aluno também excluirá as matrículas relacionadas à ela.</h3>
            </div>
            <div class="d-grid gap-2 col-6 mx-auto">
                <a type="submit" href="<?php echo $link_deleteAluno ?>?id=<?php echo $results['idAluno']; ?>" class="btn btn-danger btn-lg">EXCLUIR</a>
            </div>
        </form>
        <hr />
        <div class="d-grid gap-2 col-6 mx-auto">
