<?php
$title = "Cadastro Educação - Exclusão de Turma";
...
$link_deleteTurma = '../../Controller/deleteTurma.php';
?>
...
<div class="container-fluid" style="width:100%; justify-content: center; text-align: center; ">
    ...
    <div>
        ...
        <hr />
        <form method="GET" action="<?php echo $link_deleteTurma ?>">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    ...
                    <h3><strong>Turno: </strong> <?php echo $results['turno']; ?></h3>
                    <h3><strong>Escola: </strong> <?php echo $escolaTurma['nome']; ?></h3>
                </div>
            </div>
            <div>
                <h3>Excluir esta Turma também excluirá todas as matrículas relacionadas a ela.</h3>
            </div>
            <div class="d-grid gap-2 col-6 mx-auto">
                <a href="<?php echo $link_deleteTurma ?>?id=<?php echo $results['idTurma']; ?>" class="btn btn-danger btn-lg">EXCLUIR</a>
            </div>
        </form>
        <hr />
        <div class="d-grid gap-2 col-6 mx-auto">
